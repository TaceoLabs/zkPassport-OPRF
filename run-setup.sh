...
start_node() {
    ...
    TACEO_OPRF_NODE_BIND_ADDR=0.0.0.0:$port \
    TACEO_OPRF_NODE_SERVICE_ORACLE_HEALTH_CHECK_URL="http://127.0.0.1:8080" \
    TACEO_OPRF_NODE_SERVICE_ORACLE_VERIFIER_URL="http://127.0.0.1:8080/verify-oprf-auth?devmode=true" \
    TACEO_OPRF_NODE_SERVICE_OPRF_ENVIRONMENT=dev \
    TACEO_OPRF_NODE_SERVICE_OPRF_VERSION_REQ=">=0.0.0" \
    TACEO_OPRF_NODE_SERVICE_OPRF_WS_MAX_MESSAGE_SIZE=262144 \
    TACEO_OPRF_NODE_SERVICE_OPRF_STORE_TTL=0s \
    TACEO_OPRF_NODE_SERVICE_OPRF_STORE_TTI=0s \
    TACEO_OPRF_NODE_POSTGRES_CONNECTION_STRING=$db_conn \
    TACEO_OPRF_NODE_POSTGRES_SCHEMA=oprf$i \
